  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mt-8">
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
        <SparklesIcon className="h-7 w-7 mr-3 text-yellow-500" />
      ...
      <div className="mt-4">
        <label htmlFor="customerProfile" className="block text-sm font-medium text-gray-700 dark:text-gray-200">
      ...
      {pitch && (
        <div className="mt-6 p-4 border-l-4 border-yellow-500 bg-yellow-50 dark:bg-gray-700 rounded-r-lg">
          <h4 className="text-xl font-bold text-gray-900 dark:text-white">{pitch.title}</h4>
          <p className="mt-2 text-gray-700 dark:text-gray-200 whitespace-pre-wrap">{pitch.pitch}</p>
        </div>
      )}
    </div>
  );
